    ...
    return Scaffold(
      ...
      body: Container(
          ...
          child: GetBuilder<Zacatcontroller>(builder: (controller) {
            ...
            controller.totalzakat = (double.parse(
                ...
                double.parse(controller.zakat[0].zakattotaldebtsvalue ?? '0');
            return Handlingview(
                      ...
                      child: Column(
                        children: [
                          Custemrow(
                            ...
                            Prise: controller.zakat[0].zakatTotalAssetValue ??
                                "0,00",
                            DA: "DA".tr,
                            fontSize: 20,
                            color: AppColor.backgroundcolor,
                          ...
                          Custemrow(
                            ...
                            Prise: controller.zakat[0].zakattotaldebtsvalue ??
                                "0,00",
                            DA: "DA".tr,
                            fontSize: 20,
                            color: AppColor.backgroundcolor,
