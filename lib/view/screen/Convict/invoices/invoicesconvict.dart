                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final filteredInvoices =
                      ...
                      final isPaid = double.parse(inv.invoicesum!.toString()) <=
                          double.parse(inv.paymentPrice!.toString());
                      if (controller.selectedIndex == 1) return isPaid;
                      if (controller.selectedIndex == 2) return !isPaid;
                      return true;
                    ...
                    return TweenAnimationBuilder(
                      ...
                      child: Custemcartinvoice(
                        ...
                        Mon: controller.getMonthAbbreviation(inv.invoiesDate),
                        ...
                        onTap: () {
                          controller.gotoShowInvoice(inv.id!);
                        },
                        onEdit: () {
                          showDialog(
                            context: context,
                        ...
                        onDelete: () {
                          Get.defaultDialog(
                            ...
                            titleStyle: const TextStyle(
                                fontWeight: FontWeight.bold,
                                color: AppColor.backgroundcolor),
                            middleText: "Do you want to delete the invoice?".tr,
                            onConfirm: () {
