...
class Shwoinvoicedealer extends StatefulWidget {
  const Shwoinvoicedealer({super.key});

  @override
  State<Shwoinvoicedealer> createState() => _ShwoinvoicedealerState();
}

class _ShwoinvoicedealerState extends State<Shwoinvoicedealer> {
                  ...
                  MaterialButton(
                    onPressed: () {
                      controller.Addproduct(
                          3, controller.invoice!.invoice!.id!);
                    },
                    child: Container(
                            ...
                            widget: ListView.builder(
                              ...
                              itemBuilder: (Context, index) {
                                ...
                                return Custemrowprodact(
                                  onTap: () {
                                    controller.GotoEdititemdealer(pro!.id!);
                                  },
                                  onLongPress: () {
                                    Get.defaultDialog(
                                      backgroundColor: AppColor.white,
                                  ...
                                  price: pro?.productPricePurchase ?? "",
                                  fontSize: 17,
                                  color: AppColor.grey,
                                  colorp: AppColor.grey,
                                  da: "DA".tr,
                                  q: pro?.productQuantity ?? "",
                                  value: pro?.productPriceTotalPurchase ?? "",
                                );
                              },
                            )),
                      ),
